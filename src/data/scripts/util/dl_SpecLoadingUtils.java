...
public final class dl_SpecLoadingUtils {
     ...
     */
    public static class dl_RiftSpecLoading {
        ...
        public static void loadJSON() throws JSONException, IOException {
            JSONArray droneBehaviorSpecJson = getDroneBehaviour(getFilenameForSystemID(dl_DroneRift.UNIQUE_SYSTEM_PREFIX));
            int maxDeployedDrones = droneSystemSpecHashMap.get(dl_DroneRift.UNIQUE_SYSTEM_PREFIX).maxDeployedDrones;
